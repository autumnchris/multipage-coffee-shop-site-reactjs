    ...
    <React.Fragment>
      ...
      <section className="main-content about">
        ...
        <section className="content-container">
          <figure>
            <img src={foundersOurStory} alt="photo of founders smiling at camera in the shop's kitchen" />
          </figure>
        ...
        <section className="content-container">
          <figure>
            <img src={foundersOurMission} alt="photo of founders brewing coffee in the shop's kitchen" />
          </figure>
